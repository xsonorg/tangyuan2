...
public class XmlMongoShardingBuilder2 extends DefaultXmlComponentBuilder {
	...
	private void buildShardingTableNode(List<XmlNodeWrapper> contexts) {
		...
		for (int i = 0; i < size; i++) {
			...
			MongoDataSourceVo dsVo = this.componentContext.getDataSourceVoMap().get(dataSource);
			if (null == dsVo) {
