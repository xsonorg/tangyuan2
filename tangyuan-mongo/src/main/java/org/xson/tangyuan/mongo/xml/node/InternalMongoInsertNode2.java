 ...
 * 内部的InsertNode
 */
public class InternalMongoInsertNode2 extends AbstractMongoNode {

	private static Log log = LogFactory.getLog(InternalMongoInsertNode2.class);
	...
	public InternalMongoInsertNode2(String dsKey, String rowCount, String incrementKey, TangYuanNode sqlNode, CacheCleanVo cacheClean) {
		this.dsKey = dsKey;
