...
public class MongoCommandNode extends AbstractMongoNode {
	...
	public MongoCommandNode(String id, String ns, String serviceKey, String dsKey, TangYuanNode sqlNode, CacheUseVo cacheUse, CacheCleanVo cacheClean, Class<?> resultType,
