...
public class InternalMongoCommandNode extends AbstractMongoNode {
	...
	public InternalMongoCommandNode(String dsKey, String resultKey, String rowCount, String incrementKey, TangYuanNode sqlNode, Class<?> resultType, MappingVo resultMap,
	...
	protected Object executeSql(ActuatorContext ac, MongoServiceContext context, Object acArg) throws Throwable {
		...
		if (result instanceof InsertReturn) {
			...
			if (null != this.resultKey) {
				Ognl.setValue(acArg, this.resultKey, ir.getColumns());
				return null;
			}
		}
