...
public class DSPropertyUtil {
	 ...
	 * @return
	 */
	public static String getPropertyStringValue(String property, Map<String, String> properties, Map<String, String> decryptProperties, String defaultValue,
			boolean throwEx) {
		String value = null;
	...
	public static int getPropertyIntegerValue(String property, Map<String, String> properties, Map<String, String> decryptProperties, Integer defaultValue,
			boolean throwEx) {
		Object value = null;
		value = properties.get(property.toUpperCase());
		if (null == value) {
