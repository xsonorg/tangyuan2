...
public class AfterJoinVo extends AspectVo {

	protected static Log log = LogFactory.getLog(AfterJoinVo.class);

	public AfterJoinVo(String exec, int order, List<String> includeList, List<String> excludeList) {
		this.exec = exec;
		this.order = order;
