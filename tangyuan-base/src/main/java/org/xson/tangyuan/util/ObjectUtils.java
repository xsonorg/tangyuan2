...
public class ObjectUtils {
	 ...
	 * 
	 * @param array
	 *            the array to check (may be {@code null}, in which case the return value will always be {@code false})
	 * @param element
	...
	/**
	 * Check whether the given array of enum constants contains a constant with the given name, ignoring case when determining a
	 * match.
	 * 
	 * @param enumValues
	 ...
	 * {@code null}.
	 * <p>
	 * Compares arrays with {@code Arrays.equals}, performing an equality check based on the array elements rather than the array
	 * reference.
	 * 
	 * @param o1
	...
	/**
	 * Return as hash code for the given object; typically the value of {@code Object#hashCode()} . If the object is an array,
	 * this method will delegate to any of the {@code nullSafeHashCode} methods for arrays in this class. If the object is
	 ...
	 * <p>
	 * Differs from {@link #nullSafeToString(Object)} in that it returns an empty String rather than "null" for a {@code null}
	 * value.
	 * 
	 * @param obj
