...
public class Pipeline2 {
	...
	private Pipeline2(String serviceURI, Object arg) {
		this.firstArg = arg;
		this.serviceList = new ArrayList<String>();
		this.serviceList.add(serviceURI);
	}

	public static Pipeline2 create(String serviceURI, Object arg) {
		return new Pipeline2(serviceURI, arg);
	}

	public Pipeline2 next(String serviceURI) {
		this.serviceList.add(serviceURI);
		return this;
	}

	public Pipeline2 next(String serviceURI, ErrorHandler eh) {
		this.serviceList.add(serviceURI);
		return this;
	}
