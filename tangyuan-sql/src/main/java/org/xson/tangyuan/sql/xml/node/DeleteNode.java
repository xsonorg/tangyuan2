...
public class DeleteNode extends AbstractSqlNode {
	...
	public DeleteNode(String id, String ns, String serviceKey, String dsKey, XTransactionDefinition txDef, TangYuanNode sqlNode, CacheCleanVo cacheClean, String desc,
			String[] groups) {
		this.id = id;
		this.ns = ns;
	...
	//		sqlContext.beforeExecute(this);
	//		//		return sqlContext.executeDelete(this);
	//		Object result = sqlContext.executeDelete(this);
	//		// 7. 设置结果
	//		ac.setResult(result);
	//		return result;
