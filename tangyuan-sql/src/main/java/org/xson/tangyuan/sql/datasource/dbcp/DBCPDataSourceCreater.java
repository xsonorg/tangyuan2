...
public class DBCPDataSourceCreater implements DataSourceCreater {
	...
	//		}
	//		dsPool.setUrl(url);
	//		dsPool.setPoolPreparedStatements(
	//				DSPropertyUtil.getPropertyBooleanValue("poolingStatements", properties, null, true, true)); // 开启池的prepared
	//																																			// 池功能
	//		dsPool.setRemoveAbandoned(
	//				DSPropertyUtil.getPropertyBooleanValue("removeAbandoned", properties, null, true, true));
	//		dsPool.setRemoveAbandonedTimeout(
	//				DSPropertyUtil.getPropertyIntegerValue("removeAbandonedTimeout", properties, null, 1000, true));
	//		dsPool.setLogAbandoned(DSPropertyUtil.getPropertyBooleanValue("logAbandoned", properties, null, true, true));
	//
	//		dsPool.setInitialSize(DSPropertyUtil.getPropertyIntegerValue("initialSize", properties, null, 2, true));
	//		dsPool.setMaxActive(DSPropertyUtil.getPropertyIntegerValue("maxActive", properties, null, 8, true));
	...
	//		dsPool.setMaxWait(DSPropertyUtil.getPropertyIntegerValue("maxWait", properties, null, 10000, true));
	//
	//		dsPool.setTimeBetweenEvictionRunsMillis(
	//				DSPropertyUtil.getPropertyIntegerValue("timeBetweenEvictionRunsMillis", properties, null, -1, true));
	//
	//		dsPool.setTestOnBorrow(DSPropertyUtil.getPropertyBooleanValue("testOnBorrow", properties, null, false, true));
	//		dsPool.setTestOnReturn(DSPropertyUtil.getPropertyBooleanValue("testOnReturn", properties, null, false, true));
	//		dsPool.setTestWhileIdle(DSPropertyUtil.getPropertyBooleanValue("testWhileIdle", properties, null, false, true));
	//
	//		String validationQuery = DSPropertyUtil.getPropertyStringValue("validationQuery", properties, null, null,
	//				false);
	//		if (null != validationQuery) {
	//			dsPool.setValidationQuery(validationQuery);
	//		}
	...
	//		}
	//
	//		dsPool.setNumTestsPerEvictionRun(
	//				DSPropertyUtil.getPropertyIntegerValue("numTestsPerEvictionRun", properties, null, 10, true));
	//		dsPool.setMinEvictableIdleTimeMillis(
	//				DSPropertyUtil.getPropertyIntegerValue("minEvictableIdleTimeMillis", properties, null, 60000, true));
	//
	//		// mysql:select 1
	//		// oracle:select 1 from dual
	//		// sqlserver:select 1
